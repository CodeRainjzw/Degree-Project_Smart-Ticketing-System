                                        ...
                                        <div class="product-box-layout3 top-rated-list">
                                            ...
                                            <div class="product-info">
                                                <div class="item-content">
                                                    <h3 class="item-title">
                                                        <%= eventDAO.getEvents().get(i).getEname()%>
                                                        <p>Venue: <%=buyDAO.VnameofTicket(eventDAO.getEvents().get(i).getEname())%></p>
                                                    <p>Address: <%=eventDAO.getAddressofVenue(eventDAO.getEvents().get(i).getEname())%></p>
                                                    <p>Start Time: <%=buyDAO.TimeofTicket(eventDAO.getEvents().get(i).getEname())%></p>
                                                ...
                                                <div class="item-right">
                                                    ...
                                                    <div class="item-btn">
                                                        <a href="seat.jsp?ename=<%=eventDAO.getEvents().get(i).getEname()%>">Details</a>
                                                    </div>
                                                </div>
                                            </div>
