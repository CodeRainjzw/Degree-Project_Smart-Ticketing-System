    ...
    <section class="section-padding-equal-70 bg-accent">
        <div class="container">
            <div class="error-page-box-layout1">
                    ...
                    %>
                <h2 class="item-title">You have already log in an account, username is <%=u.getUname()%></h2>
                    <div>Do you want to Log out?</div>
                    <a href="MidLogout.jsp?log_out=1" class="error-btn">Yes, please</a>
                    <a href="index.jsp" class="error-btn">No, return to homepage</a>
            </div>
        </div>
    </section>
    <!--=====================================-->
