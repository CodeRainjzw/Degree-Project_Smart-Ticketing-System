    ...
    <section class="section-padding-equal-70 bg-accent">
        <div class="container">
            <div class="error-page-box-layout1">
                ...
                <h2 class="item-title">Add money:</h2>
                    <form action="MidRecharge.jsp" method="GET">
                    	<div class="temp">
                    	<div class="form-group"><label>Credit Card Number:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="num"></div>
                    	<div class="form-group"><label>Credit Card Password:</label>&nbsp;&nbsp;&nbsp;<input type="password" name="pass"></div>
                        <div class="form-group"><label>Recharge amount: </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="money"></div>
                        </div>
                        <div class="button-buy">
                            <button class="buy" type="submit"  >Pay with this card</button>
                            <div class="error-page-box-layout1">
                				<a href="account.jsp" class="error-btn">Return to my account.</a>
            				</div>
                        </div>
                    </form>
