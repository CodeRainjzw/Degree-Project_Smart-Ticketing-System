    ...
    <section class="section-padding-equal-70 bg-accent">
        <div class="container">
            <div class="error-page-box-layout1">
                ...
                <h2 class="item-title">Please enter your card information</h2>
                <form action="MidCard.jsp" method="POST">
                    Card Number: <input type="text" name="cardNum">
                    Card Password: <input type="password" name="cardPass">
                    <input name="number" value="<%=seatNum%>" type="hidden">
                    <input name="eventname" value="<%=ename%>" type="hidden">
                    <input name="payway" value="card" type="hidden">
