...
//                                            buyDAO.buyTicket(i,ename,u.getUname());
                                ...
                                %>
                                <div id="googleMap" class="google-map" style="width: 100%; ">
                                    <div class="container">
                                            <div class="row">
                                                <div class="col-lg-9">
...
<%--                                                                <div class="light-box-content">--%>
                                                                    ...
                                                                    <div class="static-report">
                                                                        ...
                                                                        <div class="report-list">
                                                                            <div class="report-item">
                                                                                ...
                                                                                <div class="item-value"><%=ename%></div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="report-list">
                                                                            <div class="report-item">
                                                                                <label>Seat id:</label>
                                                                                <div class="item-value" id="seatid">
                                                                                    <%
                                                                        ...
                                                                        <div class="report-list">
                                                                            <div class="report-item">
                                                                                ...
                                                                                <div class="item-value" id="price">
                                                                                    <%
                                                                                        float price = 0;
                                                                                        if (request.getParameter("type")==null) {

                                                                                            for (int i = 0; i < seatid.size(); i++) {
                                                                                                price += buyDAO.PriceofTicket(ename, seatid.get(i));
                                                                                            }
                                                                                        }
                                                                                        else {
                                                                                            price = Float.valueOf(request.getParameter("type"));
                                                                                        }
                                                                                        if (price==0){
                                                                                        	%>
                                                                                            <script>
                                        ...
                                        %>
                                        <form action="PayWay.jsp" method="post" >
                                            ...
                                            <div class="button-buy">
                                                ...
                                                <button class="buy" type="submit"  >Confirm and choose the payway</button>
                                            </div>
                                        </form>
                                        <%
                                        }
                                        ...
                                        %>
                                        <form action="MidBuyMarket.jsp" method="post" >

                                            <input type="hidden" value="<%=seatNum%>" name="number">
                                            <input type="hidden" value="<%=ename%>" name="eventname">
                                            <%
                                                String seller = String.valueOf(request.getParameter("seller"));
                                                int hash = Integer.valueOf(request.getParameter("hash"));
                                            %>
                                            <input type="hidden" value="<%=hash%>" name="hash">
                                            <input type="hidden" value="<%=seller%>" name="seller">
                                            <input type="hidden" value="<%=request.getParameter("type")%>" name="price">
                                            <%
                                                for (int i = 0 ;i<seatid.size();i++){
                                            %>
                                            <input name="<%=seatid.get(i)%>" value="<%=seatid.get(i)%>" type="hidden">
                                            ...
                                            <div class="button-buy">
                                                <input type="hidden" value="seat.jsp" name="url">
                                                <button class="buy" type="submit"  >Confirm and Buy</button>
                                            </div>
                                        </form>
                                        <%
                                            }
