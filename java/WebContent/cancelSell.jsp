    ...
    <section class="section-padding-equal-70 bg-accent">
        <div class="container">
            <div class="error-page-box-layout1">
                ...
                <h2 class="item-title">Are you sure that you want to cancel sell the ticket?</h2>
                <form action="MidCancelSell.jsp" method="POST">
                    <input type="hidden" name="ticket" value='<%=ticket%>'>
                    <div class="button-buy">
                        <button class="buy" type="submit"  >&nbsp;Yes, please cancel it&nbsp;</button>
                        <div class="error-page-box-layout1">
