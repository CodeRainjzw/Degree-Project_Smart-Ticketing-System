            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumbs-area">
                        <h1>All of my tickets</h1>
                        <ul>
                            <li>
                                <a href="index.jsp">Home</a>
                            </li>
                            <li><a href="account.jsp">My Account</a></li>
                            <li>All of my tickets</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="product-list-view">
                                        ...
                                        <div class="product-box-layout3 top-rated-list">
                                            ...
                                            <div class="product-info">
                                                <div class="item-content">
                                                    <h3 class="item-title">
                                                        <%=wallet.getValuebyKey( ticket.get(i),"ename")%>
                                                    </h3>
                                                    <p>Start time: <%=wallet.getValuebyKey( ticket.get(i),"etime")%></p>
                                                    <p>Seat Number: <%=wallet.getValuebyKey( ticket.get(i),"seatnum")%></p>
                                                    <p>Price: <%=wallet.getValuebyKey( ticket.get(i),"price")%></p>
                                                    <p>Venue Name: <%=wallet.getValuebyKey( ticket.get(i),"vname")%></p>
                                                    <p>Address: <%=wallet.getValuebyKey( ticket.get(i),"address")%></p>

                                                </div>

												<div class="item-right">
												<div class="item-btn cancel">
                                                        <form action="generate.jsp" method="POST" >
                                                            <input type="hidden" name="hash" value='<%=userDAO.getIDofTicket(u.getUname(),ticket.get(i))%>'>
                                                            <div class="button-buy">
                                                                <button class="buy" type="submit" >QRCode</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    <div class="item-btn cancel">
                                                        <form action="cancel.jsp" method="POST" >
                                                            <input type="hidden" name="ticket" value='<%=ticket.get(i)%>'>
                                                            <div class="button-buy">
                                                                <button class="buy" type="submit" >Cancel&ensp;</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    <div class="item-btn cancel">
                                                        <form action="Sell.jsp" method="POST" >
                                                            ...
                                                            <div class="button-buy">
                                                                <button class="buy" type="submit" >Resale&ensp;</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    ...
                                                    <div class="item-btn cancel">
                                                        <form action="transfer.jsp" method="POST" >
                                                            <input type="hidden" name="ticket" value='<%=ticket.get(i)%>'>
                                                            <div class="button-buy">
                                                                <button class="buy" type="submit" >Send&nbsp;&ensp;&ensp;</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                    ...
                                    <div class="product-list-view">
                                        <div class="list-view-layout1">
                                            <%
                                                List <String > sellticket = new ArrayList<>();
                                                sellticket = userDAO.getmySellingTickets(u.getUname());
                                                for (int i = 0;i< sellticket.size();i++) {
                                            %>
                                            <div class="product-box-layout3 top-rated-list">
                                                <div class="item-img">
                                                ...
                                                <div class="product-info">
                                                    <div class="item-content">
                                                        <h3 class="item-title">
                                                            <%=wallet.getValuebyKey( sellticket.get(i),"ename")%>
                                                        </h3>
                                                        <p>Start time: <%=wallet.getValuebyKey( sellticket.get(i),"etime")%></p>
                                                        <p>Seat Number: <%=wallet.getValuebyKey( sellticket.get(i),"seatnum")%></p>
                                                        <p>Price: <%=wallet.getValuebyKey( sellticket.get(i),"price")%></p>
                                                        <p>Venue Name: <%=wallet.getValuebyKey( sellticket.get(i),"vname")%></p>
                                                        <p>Address: <%=wallet.getValuebyKey( sellticket.get(i),"address")%></p>

                                                    </div>

                                                        <div class="item-btn cancel">
                                                            <form action="cancelSell.jsp" method="POST" >
                                                                <input type="hidden" name="ticket" value='<%=sellticket.get(i)%>'>
                                                                <div class="button-buy">
                                                                    <button class="buy" type="submit" >Cancel Sell</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                </div>
