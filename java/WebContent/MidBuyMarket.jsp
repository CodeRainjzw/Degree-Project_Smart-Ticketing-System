...
<%
    ...
    for (int i = 1;i<=seatNum;i++) {
        ...
        if (result!=null){
            money=buysellingDAO.buysellingticket(ename,i,u.getUname(),hash,sellDAO.gettheoriginalprice(seller, hash),price,seller);
        }       
    }
%>
<!--[if lte IE 9]>
    ...
    <section class="section-padding-equal-70 bg-accent">
        <div class="container">
            <div class="error-page-box-layout1">
				...
				<%}else{%>
				<h3 class="item-title">Sorry. Your money is not enough. </h3>
                <a href="index.jsp" class="error-btn">Return to homepage</a>
                <a href="ticket.jsp" class="error-btn">Check my ticket</a>
