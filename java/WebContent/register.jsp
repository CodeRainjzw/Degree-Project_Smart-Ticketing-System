                                ...
                                <div class="form-box registration-form">
                                    <form action="MidRegister.jsp">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="registration-identity" id="registration-identity">
                                            <div class="help-block">Please enter your identity number.</div>
                                        </div>
                                        <div class="form-group">
