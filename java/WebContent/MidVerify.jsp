    ...
    <section class="section-padding-equal-70 bg-accent">
        <div class="container">
            <div class="error-page-box-layout1">
                    ...
                    String info = validateDAO.modelOne(QR);
                    if (type.equals("null")){
                    	%>
                    	<h2 class="item-title">Please choose verify model</h2>
                        <a href="verify.jsp" class="error-btn">Back</a>
                    <%
                    }
                    else if (type.equals("1")){
                            if (info==null){
                    %>
                    <h2 class="item-title">Verify Failed.<br>This is an unavailable ticket.</h2>
                    <a href="verify.jsp" class="error-btn">Check another ticket</a>
                    <%
                            }else {
                    %>
                    <h2 class="item-title">Verify Successfully.<br>Please welcome our customer.</h2>
                    <div class="item-content">
                         <p>Event name:<%= wallet.getValuebyKey( info,"name")%></p>
                        <p>Start Time: <%=wallet.getValuebyKey( info,"time")%></p>
                        <p>Seat Number: <%=wallet.getValuebyKey( info,"position")%></p>
                        <p>Price: <%=wallet.getValuebyKey( info,"price")%></p>
                    ...
                    <%
                        	...
                        	String info1 = validateDAO.modelTwo(QR,identity);
                                if (info1==null){
                    %>
                    <h2 class="item-title">Verify Failed.<br>This is an unavailable ticket.</h2>
                    <a href="verify.jsp" class="error-btn">Check another ticket</a>
                    ...
                    <h2 class="item-title">Verify Successfully.<br>Please welcome our customer.</h2>
                    <div class="item-content">
                         <p>Event name:<%= wallet.getValuebyKey( info1,"name")%></p>
                        <p>Start Time: <%=wallet.getValuebyKey( info1,"time")%></p>
                        <p>Seat Number: <%=wallet.getValuebyKey( info1,"position")%></p>
                        <p>Price: <%=wallet.getValuebyKey( info1,"price")%></p>
