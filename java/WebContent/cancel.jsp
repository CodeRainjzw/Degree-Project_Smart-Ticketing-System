    ...
    <section class="section-padding-equal-70 bg-accent">
        <div class="container">
            <div class="error-page-box-layout1">
                ...
                <h2 class="item-title">Are you sure that you want to cancel this ticket?</h2>
                <h3>If so, we will return money to your wallet with 1 yuan deduction.</h3>
                <form action="MidCancel.jsp" method="POST">
                    <input type="hidden" name="ticket" value='<%=ticket%>'>
                    <div class="button-buy">
                        <button class="buy" type="submit"  >Yes, please cancel this ticket</button>
                        <div class="error-page-box-layout1">
                <a href="ticket.jsp" class="error-btn">No, return to my ticket</a>
            </div>
                    </div>
                </form>
