...
<%
    ...
    String a = null;
    String usern = String.valueOf(request.getParameter("login-username"));
    String password = String.valueOf(request.getParameter("login-password"));   
    if(!usern.equals("") && password.equals("")){
    	response.sendRedirect("login.jsp?warning=Please enter your password");
    } else if(usern.equals("") && !password.equals("")){
    	response.sendRedirect("login.jsp?warning=Please enter your username");
    }
    else if(usern.equals("") && password.equals("")){
    	response.sendRedirect("login.jsp?warning=Please enter your username and password");
    }
    else if(!usern.equals("") && !password.equals("")){
    	user u = userDAO.Login(usern,password);
    			if (u!=null){
        			session.setAttribute("user",u);
        			a="Successfully Login";
        			if (String.valueOf(u.getUname()).equals("adm")){
           			 response.sendRedirect("manage.jsp");
        			}
    		}else{
        		a="Unsuccessfully Login";
        		response.sendRedirect("login.jsp?warning=Please enter the correct username and password");       
    		}
    }
