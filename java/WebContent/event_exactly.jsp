                                                ...
                                                <div class="item-content">
                                                    <h3 class="item-title">
                                                        <%
                                                            ...
                                                            try {
                                                                if (eventDAO.getEventbyEname(keyword)==null){
                                                            ...
                                                            %>
                                                        <%= eventDAO.getEventbyEname(keyword).getEname()%>
                                                    
                                                    </h3>
                                                    <p>Venue: <%=buyDAO.VnameofTicket(eventDAO.getEventbyEname(keyword).getEname())%></p>
                                                    <p>Address: <%=eventDAO.getAddressofVenue(eventDAO.getEventbyEname(keyword).getEname())%></p>
                                                    <p>Start Time: <%=buyDAO.TimeofTicket(eventDAO.getEventbyEname(keyword).getEname())%></p>
                                                
                                                </div>
                                                <div class="item-right">

                                                    <div class="item-btn">
                                                        <a href="seat.jsp?ename=<%=eventDAO.getEventbyEname(keyword).getEname()%>">Details</a>
                                                    </div>
                                                </div>
                                            </div>
