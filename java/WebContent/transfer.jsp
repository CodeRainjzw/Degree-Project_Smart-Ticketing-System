    ...
    <section class="section-padding-equal-70 bg-accent">
        <div class="container">
            <div class="error-page-box-layout1">
                ...
                <h2 class="item-title">Who do you want to send to?</h2>
                <form action="MidTransfer.jsp" method="POST">
                    Membership Username: <input type="text" name="newuname">
                    <input type="hidden" name="ticket" value='<%=ticket%>'>
                    <div class="button-buy">
                        <button class="buy" type="submit"  >&nbsp;&nbsp;&nbsp;Send this ticket&nbsp;&nbsp;&nbsp;</button>
                        <div class="error-page-box-layout1">
