    ...
    <section class="section-padding-equal-70 bg-accent">
        <div class="container">
            <div class="error-page-box-layout1">
                <h2 class="item-title">Resale:</h2>
                <%
                ;
                %>
                <form action="MidSell.jsp" method="GET">
                    Set Price: <input type="text" name="money">
                    <input type="hidden" name="hash" value="<%=String.valueOf(request.getParameter("hash"))%>">
                    <input type="hidden" name="type" value="<%=String.valueOf(request.getParameter("type"))%>">
                    <div class="button-buy">
                        <button class="buy" type="submit"  >Advertise this ticket</button>
                        <div class="error-page-box-layout1">
