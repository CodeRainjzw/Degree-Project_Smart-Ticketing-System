...
<div id="wrapper" class="wrapper">
    ...
    <!--=        Inner Banner Start         =-->
    <!--=====================================-->
    <section class="inner-page-banner" data-bg-image="picture/paybycard.jpg">
        <div class="container">
            <div class="row">
                <div class="col-12">
        ...
        <div class="container">
            <div class="error-page-box-layout1">
                ...
                user u = (user) session.getAttribute("user");
                	...
                	String money = String.valueOf(request.getParameter("money"));
                	
                	if(num.equals("") || pass.equals("") || money.equals("")){
                		
                	%>
                	<h2 class="item-title">Please fill out all blanks</h2>
                	<a href="recharge.jsp" class="error-btn">Back</a>
                	<%
                	}else{
                	int number = Integer.valueOf(num);
                	float amount=Float.valueOf(money);
                	float pay=payDAO.paybycard(number, pass);
                	
                	if(pay>0 && amount>0){
                	userDAO.increaseBalance(amount,u.getUname());
                	
                %>
                <h3 class="item-title">You have recharged <%=amount%> yuan.</h3>
                <a href="account.jsp" class="error-btn">Back</a>
                <%}else if(amount<=0){ %>
                <h3 class="item-title">Please input the correct recharge money.</h3>
                <a href="recharge.jsp" class="error-btn">Back</a>  
                <%} else if(pay<0 && amount>0){ %>
                <h3 class="item-title">This card is not available, please use another one.</h3>
                <a href="recharge.jsp" class="error-btn">Back</a>  
                <%}               
                 else{%>
                <h3 class="item-title">Please enter the correct card number and password</h3>
                <a href="recharge.jsp" class="error-btn">Back</a><%}
                	}	
                %>
            </div>
