...
<%
    ...
    sellDAO.setoriginalinfo(u.getUname(),sellDAO.changetooriginalInfo(u.getUname(),hash,sellDAO.gettheoriginalprice(u.getUname(),hash)),hash);
    userDAO.userconfirmcancelsell(u.getUname(),hash);
...
<div id="wrapper" class="wrapper">
    ...
    <!--=        Inner Banner Start         =-->
    <!--=====================================-->
    <section class="inner-page-banner" data-bg-image="picture/cancel.jpg">
        <div class="container">
            <div class="row">
                <div class="col-12">
    ...
    <section class="section-padding-equal-70 bg-accent">
        <div class="container">
            <div class="error-page-box-layout1">
                <h2 class="item-title">You have cancelled selling ticket: "<%=wallet.getValuebyKey( ticket,"ename")%>" Successfully.</h2>
